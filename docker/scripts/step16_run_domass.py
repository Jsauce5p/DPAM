...
# Enable v1 compatibility mode in TensorFlow 2.x
tf.compat.v1.disable_eager_execution()

# Import device_lib using compat.v1
...
# Using tf.compat.v1 for dense layers and placeholders
dense = tf.compat.v1.layers.dense
with tf.compat.v1.Graph().as_default():
    with tf.compat.v1.name_scope('input'):
        myinputs = tf.compat.v1.placeholder(dtype = tf.float32, shape = (100, 13))
    layers = [myinputs]
